...
var unmarshalTests = []unmarshalTest{
	...
	{in: `{"x": 1}`, ptr: new(tx), out: tx{}, err: errors.New("JSON decoder found unexpected key: x")},
	...
	{in: `{"alphabet": "xyz"}`, ptr: new(U), out: U{}, err: errors.New("JSON decoder found unexpected key: alphabet")},
